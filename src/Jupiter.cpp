...
int Jupiter::model_s = 0;
int Jupiter::model_t = 0;

Jupiter::Jupiter(float x, float y, float z, float ang_x, float ang_y, float ang_z) {
    _posicion.pos_x = x;
    _posicion.pos_y = y + 1;
    _posicion.posZ = z;
...
void Jupiter::Draw(ModelType m, data_camera camara) {
    glPushMatrix();
...
void Jupiter::TimeEvolution(float t) {
