...
int Jupiter::ModeloS = 0;
int Jupiter::ModeloT = 0;

Jupiter::Jupiter(float x, float y, float z, float angX, float angY, float angZ) {
    _posicion.posX = x;
    _posicion.posY = y + 1;
    _posicion.posZ = z;
...
void Jupiter::Dibujar(Tipo_Modelo m, Datos_Camara camara) {
    glPushMatrix();
...
void Jupiter::EvolucionTiempo(float t) {
