...
int Neptuno::model_s = 0;
int Neptuno::model_t = 0;

Neptuno::Neptuno(float x, float y, float z, float ang_x, float ang_y, float ang_z) {
    _posicion.pos_x = x;
    _posicion.pos_y = y + 1;
    _posicion.posZ = z;
...
void Neptuno::Draw(ModelType m, data_camera camara) {
    glPushMatrix();
