#include "../include/Venus.h"

int Venus::ModeloS = 0;
int Venus::ModeloT = 0;

Venus::Venus(float x, float y, float z, float angX, float angY, float angZ) {
    _posicion.posX = x;
    _posicion.posY = y + 1;
    _posicion.posZ = z;
...
void Venus::Dibujar(Tipo_Modelo m, Datos_Camara camara) {
    glPushMatrix();
...
void Venus::EvolucionTiempo(float t) {
